...
def preference(tt,subject_faculty,temp):
    ...
    payload = "sender_id=FSTSMS&message=Day-%s,Section-%s,Lecture-%s,Subject-%s%s&language=english&route=p&numbers=8770631461" %(day, section, temp, arr, " has been alloted to you") 
    headers = {
